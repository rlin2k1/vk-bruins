""" pi1_dimension_stream_2.py
Sends Picture Frames Across the Socket to the Connected Server

The Computer is the Server - Awaiting Images from the Client(Raspberry Pi 1),

USAGE: python pi1_dimension_stream_2.py
...
client_socket.connect(('192.168.0.114', 8000)) #Connect to the Computer
